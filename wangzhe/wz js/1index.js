(function () {
	let container = document.querySelector(".ggBox"),
		wrapper = container.querySelector(".adPic"),
		slideList = Array.from(wrapper.querySelectorAll(".f1")),
		panginationList = Array.from(container.querySelectorAll(".adBtn a"));
