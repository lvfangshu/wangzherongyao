(function () {
	let container = document.querySelector(".newsTab"),
		wrapper = container.querySelector(".news_con"),
		slideList = Array.from(wrapper.querySelectorAll(" #news-list news-list0")),
		panginationList = Array.from(container.querySelectorAll(".news_center .tab_hd li"));
